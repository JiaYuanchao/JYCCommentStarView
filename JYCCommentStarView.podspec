#
# Be sure to run `pod lib lint JYCCommentStarView.podspec' to ensure this is a
...
JYCCommentStarView: A simple view show comment star and select star grade.
  ...
  s.source           = { :git => 'https://github.com/jiayuanchao/JYCCommentStarView.git', :tag => s.version.to_s }
